...
short: 'Just a few minutes before the departure we managed to get into a train. It was the old-type train with no compartments. Seats were placed around a little table in groups of four and of course, we took all of them, so we could have our private'
image: balkans/arad_railway.jpg
---
